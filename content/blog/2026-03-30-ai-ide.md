...
In this new LLM world, we are becoming terribly productive and we need tools to manage many projects and many features, being continuously developed, by a single person. This is the new "IDE" I'm talking about. I like to call it Ambient Development, since it is something you jump in and out of. sometimes tweaking a lot, sometime just nudging in a new direction. The agent takes over and continues your "theme" while you sleep.

Here are some of the projects I cooked up in the past month or so.
