...
This post is a survey of that space while it is still taking shape. There are many tools that are sprouting up everyday to suit people's personal needs. Here, I am looking at only several of them that have active communites, even though there are a ton of [fun one-off ideas in this space](https://www.reddit.com/r/ClaudeCode/comments/1sa4ow1/this_is_my_favorite_way_to_vibe_code/). Things are moving fast so this post will almost certainly not be relevant past March 2026.
...
Tmux and the like (Zellij, WezTerm, cmux, limux) are having quite a renaissance right now. As [someone recently asked on /r/tmux](https://www.reddit.com/r/tmux/comments/1saciat/so_is_this_subreddit_just_claude_code_tmux/), "So is this subreddit just claude code tmux plugins now?"
